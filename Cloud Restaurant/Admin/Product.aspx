<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="Cloud_Restaurant.Admin.Product" %>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" OnSelecting="SqlDataSource1_Selecting"
                                                            ConnectionString="<%$ ConnectionStrings:CloudDBConnectionString %>" 
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:LinkButton ID="lblDelete" Text="Delete" runat="server" CssClass="badge bg-danger" CausesValidation="false"
