<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Report.aspx.cs" Inherits="Cloud_Restaurant.Admin.Report" %>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="row pl-4">
                                        <asp:Label ID="lblTotal" runat="server" Font-Size="Small"></asp:Label>
                                    </div>
                                </div>
                            </div>
                        </div>
