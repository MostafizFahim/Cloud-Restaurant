<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="Cloud_Restaurant.Admin.Dashboard" %>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <h4><% Response.Write(Session["soldAmont"]); %></h4>
                                    <div>
                                        <span class="f-left m-t-10 text-muted"></span>
